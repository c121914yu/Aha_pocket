...
/* 更新团队信息 */
exports.putTeam = function (data) {return (0, _request.default)("/team/".concat(data.id), "PUT", data);};
/* 解散团队 */
...
/* 审核申请表 */
exports.checkApply = function (_ref4) {var teamId = _ref4.teamId,memberId = _ref4.memberId,state = _ref4.state;return (0, _request.default)("/team/apply/check/".concat(teamId, "/").concat(memberId), "POST", { state: state });};
