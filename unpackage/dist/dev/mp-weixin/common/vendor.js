...
/* 获取团队列表 */
exports.getTeams = function (teamId) {return (0, _request.default)("/team/", "GET", {});};
/* 获取单个团队详细 */
exports.getTeam = function (teamId) {return (0, _request.default)("/team/" + teamId, "GET", {});};
/* 创建团队 */
...
/* 修改队员信息 */
exports.putMemberInfo = function (_ref2) {var teamId = _ref2.teamId,role = _ref2.role,memberIntro = _ref2.memberIntro;return (0, _request.default)("/team/member/".concat(teamId), "PUT", { role: role, memberIntro: memberIntro });};
/* 删除队员 */
...
/* 使用兑换码 */
exports.useCDKEY = function (code) {return (0, _request.default)("/activity/code?code=" + code, "POST", {});};
